<?php 
    ...
    //request method post
    if( $_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['topSaleSubmit']) ){
...
<!-- Top Sale -->
        <section id="topSale">
            <div class="container py-5">
                <h4 class="fontRubik fontSize20">Top Sale</h4>
                <hr>
                <!-- Owl Carousel -->
                                ...
                                <form method="post">
                                    ...
                                    <?php
                                        if (in_array($item['item_id'], $inCart)){
                                            ...
                                            echo '<button type="submit" name="topSaleSubmit" class="btn btn-warning font-size-12">Add to Cart</button>';
                                        }
                                    ?>
                                </form>
                            </div>
