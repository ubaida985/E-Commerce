    ...
    <div class="copyright text-center bg-dark text-white py-2">
        <p class="fontRaleway fontSize16">&copy;2022 Designed by <a href="ubaida985.github.io/portfolio/"
                class="colorPrimary">Ubaid Ahmad</a> and <a href="https://github.com/sayakghosh26"
                class="colorPrimary">Sayak Ghosh</a></p>
    </div>
    <!-- Footer Section ends -->
