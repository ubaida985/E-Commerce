...
--
INSERT INTO `logs` (`id`, `email_id`, `session`)
VALUES (
    1,
    'ubaida9851234@gmail.com',
    '2022-01-24 20:15:01'
  );
-- --------------------------------------------------------
--
...
--
INSERT INTO `user` (`name`, `email_id`, `mobile`, `password`)
VALUES (
    'Sayak Ghosh',
    'sayakChor@gmail.com',
    1234567890,
...
-- Triggers `user`
--
DELIMITER $$ CREATE TRIGGER `insertLogs`
AFTER
INSERT ON `user` FOR EACH ROW
insert into logs
values(null, new.email_id, now()) $$ DELIMITER;
-- --------------------------------------------------------
--
